...
class LollmsSD:
    ...
    def __init__(
        ...
        ASCIIColors.red(" .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. ")
        ASCIIColors.red("| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |")
        ASCIIColors.red("| |   _____      | || |     ____     | || |   _____      | || |   _____      | || | ____    ____ | || |    _______   | || |              | || |    _______   | || |  ________    | |")
        ASCIIColors.red("| |  |_   _|     | || |   .'    `.   | || |  |_   _|     | || |  |_   _|     | || ||_   \  /   _|| || |   /  ___  |  | || |              | || |   /  ___  |  | || | |_   ___ `.  | |")
        ASCIIColors.red("| |    | |       | || |  /  .--.  \  | || |    | |       | || |    | |       | || |  |   \/   |  | || |  |  (__ \_|  | || |              | || |  |  (__ \_|  | || |   | |   `. \ | |")
        ASCIIColors.red("| |    | |   _   | || |  | |    | |  | || |    | |   _   | || |    | |   _   | || |  | |\  /| |  | || |   '.___`-.   | || |              | || |   '.___`-.   | || |   | |    | | | |")
        ASCIIColors.red("| |   _| |__/ |  | || |  \  `--'  /  | || |   _| |__/ |  | || |   _| |__/ |  | || | _| |_\/_| |_ | || |  |`\____) |  | || |              | || |  |`\____) |  | || |  _| |___.' / | |")
        ASCIIColors.red("| |  |________|  | || |   `.____.'   | || |  |________|  | || |  |________|  | || ||_____||_____|| || |  |_______.'  | || |   _______    | || |  |_______.'  | || | |________.'  | |")
